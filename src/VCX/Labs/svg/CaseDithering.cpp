...
#include "Labs/svg/CaseDithering.h"
// #include "Labs/1-Drawing2D/tasks.h" // Removed - old 2D drawing tasks
        ...
        if (_recompute) {
            ...
            case AlgorithmType::Threshold:
                _task.Emplace([&input = _input]() {
                    ...
                    // DitheringThreshold(tex, input); // Removed - old 2D drawing tasks
                    return tex;
                });
                break;
            case AlgorithmType::Random:
                _task.Emplace([&input = _input]() {
                    Common::ImageRGB tex(c_Size.first, c_Size.second);
                    // DitheringRandomUniform(tex, input); // Removed - old 2D drawing tasks
                    return tex;
                });
                break;
            case AlgorithmType::BlueNoise:
                _task.Emplace([&input = _input, &noise = _blueNoise]() {
                    Common::ImageRGB tex(c_Size.first, c_Size.second);
                    // DitheringRandomBlueNoise(tex, input, noise); // Removed - old 2D drawing tasks
                    return tex;
                });
                break;
            case AlgorithmType::Ordered:
                _task.Emplace([&input = _input]() {
                    ...
                    // DitheringOrdered(tex, input); // Removed - old 2D drawing tasks
                    return tex;
                });
                break;
            case AlgorithmType::ErrorDiffuse:
                _task.Emplace([&input = _input]() {
                    Common::ImageRGB tex(c_Size.first, c_Size.second);
                    // DitheringErrorDiffuse(tex, input); // Removed - old 2D drawing tasks
                    return tex;
                });
                break;
            default:
